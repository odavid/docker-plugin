...
public abstract class DockerComputerConnector extends AbstractDescribableImpl<DockerComputerConnector> {
    ...
    public final ComputerLauncher createLauncher(final DockerAPI api, CreateContainerCmd cmd, String workdir, TaskListener listener) throws IOException, InterruptedException {
        ...
        final ComputerLauncher launcher = createLauncher(api, workdir, cmd, new DockerContainerExecuter(), listener);
     ...
     */
    protected abstract ComputerLauncher createLauncher(DockerAPI api, String workdir, CreateContainerCmd cmd, DockerContainerExecuter containerExecuter, TaskListener listener) throws IOException, InterruptedException;
